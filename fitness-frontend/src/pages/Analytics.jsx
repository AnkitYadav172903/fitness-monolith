...
export default function Analytics() {
    ...
    const loadAnalytics = async () => {
        try {
            ...
            const weeklyData = Object.values(weekly).sort(
            ...
            <AnimatedPage>
                <div className="space-y-8">
                    ...
                    >
                        <AnimatedCard>
                            <ProgressCard
                                percentage={Math.min(
                                    100,
                                    Math.round(
                                        (summary.workouts / WEEKLY_GOAL_WORKOUTS) * 100
                                    )
                                )}
                            />
                        </AnimatedCard>
                        ...
                        <AnimatedCard>
                            <GoalCard completed={summary.workouts} target={WEEKLY_GOAL_WORKOUTS} />
                        </AnimatedCard>
                    </motion.div>
